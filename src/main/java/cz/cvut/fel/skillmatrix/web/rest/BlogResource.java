...
import cz.cvut.fel.skillmatrix.domain.Blog;
import cz.cvut.fel.skillmatrix.repository.BlogRepository;
...
/**
 * REST controller for managing {@link Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BlogResource {
    ...
    public List<Blog> getAllBlogs() {
        ...
        return blogRepository.findAll();//why tho, why did i comment this out?? to try the other method?
